...
class UtxPoolImpl(
  ...
  private[this] val pessimisticPortfolios = new PessimisticPortfolios(spendableBalanceChanged, blockchain.transactionHeight(_).nonEmpty, blacklistedAddressAssets, getBadAssetsDiff)
...
object UtxPoolImpl {
  ...
  private class PessimisticPortfolios(
    ...
    def getAggregated(accountAddr: Address): Portfolio = {
      ...
      val pessimistic = Monoid.combineAll(portfolios)
      val bad = {
