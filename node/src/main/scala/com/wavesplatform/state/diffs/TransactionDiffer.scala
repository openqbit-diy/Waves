  ...
  def unverified(
    ...
    stats.transactionDiffValidation.measureForType(tx.builder.typeId) {
      tx match {
        ...
        case mtx: MassTransferTransaction    => MassTransferTransactionDiff(blockchain, blockchain.settings.functionalitySettings, currentBlockTimestamp, currentBlockHeight)(mtx)
        ...
        case etx: ExchangeTransaction        => ExchangeTransactionDiff(blockchain, blockchain.settings.functionalitySettings, currentBlockHeight)(etx)
